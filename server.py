...
def kelly_einsatz(modell_p, markt_p, vol_score):
    ...
    # Niedriges Volumen → kleinerer Einsatz (mehr Risiko)
    vol_faktor = 0.5 + vol_score * 0.5   # 50%–100% je nach Volumen
    einsatz = min(KELLY * k * BANKROLL * vol_faktor, 0.06 * BANKROLL)
